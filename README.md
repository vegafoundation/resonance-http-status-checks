...
This repository contains the conceptual definition and theoretical framework for **HTTP Status Checks**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── http-status-checks.tex    # LaTeX dissertation
├── whitepaper/
│   └── http-status-checks.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025httpstatuschecks,
  author = {Vega, Adam Eren},
  title = {HTTP Status Checks: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/http-status-checks}
}
```
